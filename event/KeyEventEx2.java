...
public class KeyEventEx2 extends MFrame {
	...
	public KeyEventEx2() {
		...
		/*Adapter는 Listener를 구현한 추상클래스이고 필요한 메소드만 오버라이드 할수 있도록 제공되는 클래스
		 * ActionListener이랑 ItemListener은 Adapter 클래스 없음 <- 메소드 한개 밖에 없기 때문
		 *익명클래스를 만들수 있는 조건은 추상클래스 또는 인터페이스
		 * */
